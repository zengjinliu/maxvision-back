...
public class UserConstants
{
    ...
    /** 视频显示名称是否唯一的返回结果码 */
    public final static String SP_XS_NAME_UNIQUE = "0";
    public final static String SP_XS__NAME_NOT_UNIQUE = "1";

    /** 视频显示设备名称是否唯一的返回结果码 */
    public final static String SP_SB_NAME_UNIQUE = "0";
    public final static String SP_SB__NAME_NOT_UNIQUE = "1";
